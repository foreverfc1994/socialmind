...
function colleagueEvents() {
    colleagueEventsOption = {
        tooltip: {
            type: 'showTip',
            trigger: 'axis'
        },
        ...
        series: [
            {
                ...
                stack: '',
                color: 'red',
                data: [240, 300, 400, 250, 100, 300, 250, 290]
            }
        ],
        legend: {
            show: true
    ...
    var colleagueEvents = echarts.init(document.getElementById("colleagueEvents"));
    colleagueEvents.setOption(colleagueEventsOption);
}